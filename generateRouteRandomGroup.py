...
class Configuration:
    def __init__(self, cases):
        ...
        if cases == "Case1Low":
            ...
            route_21CGRoadtoUshmanpura = caseLow
            route_22CGRoadtoUshmanpura = caseLow
            route_23CGRoadtoUshmanpura = caseLow
            route_24CGRoadtoUshmanpura = caseLow
            route_25CGRoadtoUshmanpura = caseLow
            route_26CGRoadtoUshmanpura = caseLow
            route_27CGRoadtoUshmanpura = caseLow
            route_28CGRoadtoUshmanpura = caseLow
            route_29CGRoadtoUshmanpura = caseLow
            route_30CGRoadtoUshmanpura = caseLow
            route_31CGRoadtoUshmanpura = caseLow
            route_32CGRoadtoUshmanpura = caseLow
        ...
        if cases == "Case1Mid":
            ...
            route_21CGRoadtoUshmanpura = caseMid
            route_22CGRoadtoUshmanpura = caseMid
            route_23CGRoadtoUshmanpura = caseMid
            route_24CGRoadtoUshmanpura = caseMid
            route_25CGRoadtoUshmanpura = caseMid
            route_26CGRoadtoUshmanpura = caseMid
            route_27CGRoadtoUshmanpura = caseMid
            route_28CGRoadtoUshmanpura = caseMid
            route_29CGRoadtoUshmanpura = caseMid
            route_30CGRoadtoUshmanpura = caseMid
            route_31CGRoadtoUshmanpura = caseMid
            route_32CGRoadtoUshmanpura = caseMid
        ...
        if cases == "Case1High":
            ...
            route_21CGRoadtoUshmanpura = caseHigh
            route_22CGRoadtoUshmanpura = caseHigh
            route_23CGRoadtoUshmanpura = caseHigh
            route_24CGRoadtoUshmanpura = caseHigh
            route_25CGRoadtoUshmanpura = caseHigh
            route_26CGRoadtoUshmanpura = caseHigh
            route_27CGRoadtoUshmanpura = caseHigh
            route_28CGRoadtoUshmanpura = caseHigh
            route_29CGRoadtoUshmanpura = caseHigh
            route_30CGRoadtoUshmanpura = caseHigh
            route_31CGRoadtoUshmanpura = caseHigh
            route_32CGRoadtoUshmanpura = caseHigh
        ...
        self.pH28 = np.ones(1) * multiplier * route_26CGRoadtoUshmanpura / 3600
        self.pH29 = np.ones(1) * multiplier * route_26CGRoadtoUshmanpura / 3600
        self.pH30 = np.ones(1) * multiplier * route_26CGRoadtoUshmanpura / 3600
        self.pH31 = np.ones(1) * multiplier * route_26CGRoadtoUshmanpura / 3600
        self.pH32 = np.ones(1) * multiplier * route_26CGRoadtoUshmanpura / 3600
        ...
        self.pH = np.hstack((self.pH1 , self. pH2,self.pH3,self.pH4,self.pH5 , self. pH6,self.pH7,self.pH8,self.pH9 , self. pH10,self.pH11,self.pH12,self.pH13 , self. pH14,self.pH15,self.pH16,
                             self.pH17, self.pH18, self.pH19, self.pH20,self.pH21 , self. pH22,self.pH23,self.pH24,self.pH25 , self. pH26,self.pH27,self.pH28,self.pH29,self.pH30,self.pH31,self.pH32))
        self.routeH = []
...
<param key="has.fcd.device" value="true"/> 
    ...
    <route id="route_1" edges="right4F4 F4E4 E4D4 D4C4 C4B4 B4A4 A4left4" />
        ...
        <route id="route_20" edges="A3B3 B3B4" />
        <route id="route_21" edges="A3B3 B3B2" />
        <route id="route_22" edges="C3B3 B3B4" />
        <route id="route_23" edges="B3C3 C3C4" />
        <route id="route_24" edges="B3C3 C3C2" />
        <route id="route_25" edges="D3C3 C3C4" />
        <route id="route_26" edges="D3C3 C3C2" />
        <route id="route_27" edges="B2A2" />
        <route id="route_28" edges="B2A2" />
        <route id="route_29" edges="B2A2" />
        <route id="route_30" edges="B2A2" />
        <route id="route_31" edges="B2A2" />

    <route id="route_32" edges="D4C4"/>""",
              file=routes)
        lastVeh = 0
