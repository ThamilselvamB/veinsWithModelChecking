...
class VEINS_API TraCIDemo11p3 : public DemoBaseApplLayer {
public:
...
//    TraCIDemo11p3 det;
    ...
    cMessage* initMsg;
    cMessage* phaseMsg;
    std::string detectors1[2][5] = {
      { "areaDet1W1", "areaDet1W2", "areaDet1W3","areaDet1W4","areaDet1W5" },
      { "areaDet2E1", "areaDet2E2", "areaDet2E3" }
    };
...
protected:
    ...
    void showNow(int);
    bool Check_Atomic_Proposition(int,int,int,int,float);
    bool* EvaluateEpisetmicQuery(int,int[],int[],int[],int[],float[]);
};
